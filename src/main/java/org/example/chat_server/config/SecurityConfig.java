package org.example.chat_server.config;

import org.example.chat_server.fliter.JwtAuthenticationFilter;
import org.example.chat_server.handler.JwtAuthenticationEntryPoint;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((authz) -> authz
                        .requestMatchers("/api/**").permitAll() // 인증 관련 API -> 채팅 개발 후 제외 URL 재 세팅 필요!!!
